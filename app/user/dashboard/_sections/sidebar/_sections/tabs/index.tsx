		...
		<div className={styles.tabs_section}>
			<div className={`${styles.tabs_container} ${isScrolled ? styles.scrolled : ''} ${isHidden ? styles.hidden : ''}`}>
				<div className={styles.tabs_content}>
					<Button.UI style='ghost' type='secondary' className={`${styles.show_hide_button} ${styles.hide}`} onClick={() => setIsHidden(true)}>
					...
					<div className={styles.tabs}>
						{tabs.map((tab) => {
							...
							return (
								<Button.UI key={getKey()} style='ghost' type='secondary' name={tab} className={`${styles.tab} ${isActive ? styles.active : ''}`} onClick={handleTabClick}>
									{tab}
								</Button.UI>
							);
						})}
					...
					<div className={styles.show_container}>
						<Button.UI style='ghost' type='secondary' className={`${styles.show_hide_button} ${styles.show}`} onClick={() => setIsHidden(false)}>
