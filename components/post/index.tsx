					...
					{images.map((image) => {
						...
						return (
							<div className={styles.blog_image_container}>
								<Image key={key} src={image.src} alt='blog image' width={200} height={300} className={styles.blog_image} />
							</div>
						);
					})}
				</div>
